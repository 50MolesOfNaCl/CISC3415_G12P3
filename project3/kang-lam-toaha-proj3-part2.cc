...
{  
  ...
  std::cout << "Centering Part 1 " << counterForCentering2 << std::endl;
	...
	// It basically rotates 90 degrees before hitting walls in the crevice and makes its way into a lane
		...
		// If the counter for turning is triggered, will turn according to relevant
 		// side, for an angle that is less than but close to 90 degrees for about a
		// 3 second interval (27 cycles) (~30 degrees per second)
