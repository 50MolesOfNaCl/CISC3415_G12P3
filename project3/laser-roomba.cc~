...
{  
  ...
  while(true) 
	...
	if (leftRange + rightRange >= 2.5 && middleScanLine < 1) {
	   speed=0;
           turnrate = 0;
...
*/
	...
	// this basically checks the max values of the left-most and right-most points, adds up value, and makes sure value is between 2.3 and 2.5. Then it makes sure it's close to wall as possible before stopping. In this case .5 meters awa.
